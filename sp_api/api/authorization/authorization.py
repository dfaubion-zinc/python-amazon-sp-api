...
class Authorization(Client):
    ...
    """
    grantless_scope = u'sellingpartnerapi::migration'

    @sp_endpoint(u'/authorization/v1/authorizationCode', method=u'GET')
    def get_authorization_code(self, **kwargs):
        ...
        **Usage Plan:**
        ...
        return self._request_grantless_operation(kwargs.pop(u'path'),  params=kwargs)
